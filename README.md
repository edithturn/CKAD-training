...
```mermaid
flowchart LR
A[Application Design and Build - 20%<br />{text-align: right}* Define, build and modify container images<br />* Understand Jobs and CronJobs<br />Understand multi-container Pod design patterns e.g. sidecar, init and others<br />* Utilize persistent and ephemeral volumes] --> B
